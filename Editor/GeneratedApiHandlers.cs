...
namespace LocalRestAPI
{
    ...
    public static class PredefinedApiHandlers
    {
        ...
        /// <summary>
                ...
                /// </summary>
                public class GETapiunitysceneHandler : ThreadSafeApiHandler
                {
                    protected override bool NeedsMainThreadExecution()
                    {
                        return true; // 根据路由属性设置
                    }
        
                    protected override object ExecuteOnMainThread(HttpListenerRequest request, HttpListenerResponse response)
                    {
                        try
                        {
                            // 使用预生成的参数解析器
        ...
        /// <summary>
                ...
                /// </summary>
                public class GETapiunityobjectsHandler : ThreadSafeApiHandler
                {
                    protected override bool NeedsMainThreadExecution()
                    {
                        return true; // 根据路由属性设置
        ...
        /// <summary>
                ...
                /// </summary>
                public class POSTapiunitylogHandler : ThreadSafeApiHandler
                {
                    protected override bool NeedsMainThreadExecution()
                    {
                        return true; // 根据路由属性设置
