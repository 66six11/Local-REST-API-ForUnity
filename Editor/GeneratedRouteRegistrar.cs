...
namespace LocalRestAPI
{
    ...
    public static class PredefinedRouteRegistrar
    {
        ...
        {
            apiServer.RegisterPredefinedRoute("GET", "/api/sample/hello", 
            ...
            apiServer.RegisterPredefinedRoute("POST", "/api/sample/echo", 
            ...
            apiServer.RegisterPredefinedRoute("GET", "/api/sample/random", 
            ...
            apiServer.RegisterPredefinedRoute("GET", "/api/sample/status", 
            ...
            apiServer.RegisterPredefinedRoute("GET", "/api/unity/scene", 
            ...
            apiServer.RegisterPredefinedRoute("GET", "/api/unity/objects", 
            ...
            apiServer.RegisterPredefinedRoute("POST", "/api/unity/log", 
